...
> 代码提交：`adc7411 feat:work-orders-and-unlimited-codrive`
...
- 代码目录：`D:\Docker\yiai-center`
- 容器：`yiai-center-api-1`
- Compose 服务：`api`
- 部署动作：只构建并重建 `api`，没有重建 MCP 或主机其他容器。
- 数据库备份：`D:\Docker\yiai-center\data\yiai-center-pre-v0513-20260721.sqlite`
- 最终镜像清单：`sha256:1b7fee2337efc9a6936bf7514dc0d71310766c3ae01b89aa514634b6564802c5`
...
V0.5.13 已正式运行。AI 与员工的关系是可反复切换的输出权协同，不是一次性的人工接管流程；员工交还 AI 之后，AI 继续待命，事项也不会因为 AI 承接而自动完结。
