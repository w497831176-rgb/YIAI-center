...
- 代码回滚：使用 Git 历史恢复到 V0.5.9 代码，再重建 `api` 服务。
- Release 回滚：平台选择旧 Release 并人工回滚，下一条新消息使用旧快照。
- 数据恢复：正式数据库备份位于 `D:\Docker\yiai-center\data\yiai-center-pre-v0513-20260721.sqlite`。
